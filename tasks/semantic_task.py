...
class SemanticTask(Task):
    ...
    def load_data(self):
        ...
        if self.params.fl_sample_dirichlet:
            ...
            filtered_range = [idx for idx in all_range if idx not in exclude_indices]
            self.train_dataset = Subset(self.train_dataset, filtered_range)
